...
onMounted(() => {
  store.dispatch('fetchQuizData', 4);
  nextTick(() => {
    watchEffect(() => {
      if (loading.value && !showExplanation.value) {
        console.log("Loading animation for loading state...");
        loadAnimation('https://lottie.host/eec8ebe4-7014-421e-abe3-9196f76a3837/Cq9LneHItv.json', lottieContainerRef, true);
        ...
        const animationUrl = selectedAnswer.value.isCorrect
            ? 'https://lottie.host/eec8ebe4-7014-421e-abe3-9196f76a3837/Cq9LneHItv.json'  // Update this if you have a new URL
            : 'https://lottie.host/eec8ebe4-7014-421e-abe3-9196f76a3837/Cq9LneHItv.json';  // Update this if you have a new URL
